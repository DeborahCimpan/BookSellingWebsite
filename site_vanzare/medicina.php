            ...
            <div class="tm-main-content">
                <section class="tm-margin-b-l">
                    ...
                    <div class="tm-gallery">
						...
						<?php
						$product_array = $db_handle->runQuery("SELECT * FROM produse WHERE timp='st' and scoala='nust' and subiect='nusub' and student='da' and domeniu='medi' and tip='nudo'  ORDER BY code ASC");
						if (!empty($product_array)) { 
							foreach($product_array as $key=>$value){
						?>
						<table>
						<form method="post" action="medicina.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
