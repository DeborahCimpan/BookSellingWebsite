            ...
            <div class="tm-main-content">
                <section class="tm-margin-b-l">
                    ...
                    <div class="tm-gallery">
						...
						<?php
						$product_array = $db_handle->runQuery("SELECT * FROM produse WHERE timp='lib' and scoala='nust' and subiect='nusub' and student='nuv' and domeniu='nudom' and tip='spirit'  ORDER BY code ASC");
						...
						<form method="post" action="spirituale.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
						<figure class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
							<a href="secretele_detail.php">
