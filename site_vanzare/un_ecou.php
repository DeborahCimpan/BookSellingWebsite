            ...
            <div class="tm-main-content no-pad-b">
                ...
                <section class="row tm-item-preview">
                    <div class="col-md-6 col-sm-12 mb-md-0 mb-5">
                        <img src="assets/images/un_ecou.jpg" alt="Image" class="img-fluid tm-img-center-sm">
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <h2 class="tm-blue-text tm-margin-b-p">Un ecou în întuneric,Emblema Leului,vol II</h2>
                        
                        <p class="tm-blue-text tm-margin-b-s">Autor:Francine Rivers</p>
                        <p class="tm-blue-text tm-margin-b-s">Preț: 28,99 lei</p>
                        <p class="tm-blue-text tm-margin-b">Notă: <img src="assets/images/star.png" alt="Star image"> <img src="assets/images/star.png" alt="Star image"> <img src="assets/images/star.png" alt="Star image"> <img src="assets/images/star.png" alt="Star image"></p>
                            ...
                            <div class="full">
                                <div class="tab_bar_section">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#description">Descriere</a> </li>
                                        
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content">
                                        <div code="description" class="tab-pane active">
                                            <div class="product_desc">
                                                <p>Romanul continua povestea tinerei Hadassa dar in scena apare si Marcus. Intorcand spatele opulentei Romei, Marcus se lasa calauzit de o voce soptita, din trecut, intr-o calatorie care l-ar putea elibera din intunericul care i-a cuprins sufletul. 

Intriga naratiunii este declansata de disparitia misterioasa a Hadassei. Oare ce s-a intamplat cu ea? Acceasi intrebare si-o pune si Marcus, care, pentru a capata linistea sufleteasca porneste intr-o calatorie fascinanta in locurile copilariei Hadassei. El este macinat de gandul ca e posibil ca ea sa fi murit. 

"Francine da glas dorintei puternice din sufletul fiecaruia dintre noi de a avea o relatie personala cu Dumnezeu mai profunda, care sa duca la transformarea vietii noastre. In urma lecturii cartilor ei nu ramai neschimbat." - Debbie Macomber </p>
                                            </div>
                                        </div>
