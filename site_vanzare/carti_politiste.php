            ...
            <div class="tm-main-content">
                <section class="tm-margin-b-l">
                    ...
                    <div class="tm-gallery">
						...
						<?php
						$product_array = $db_handle->runQuery("SELECT * FROM produse WHERE timp='lib' and scoala='nust' and subiect='nusub' and student='nuv' and domeniu='nudom' and tip='poli'  ORDER BY code ASC");
						if (!empty($product_array)) { 
							foreach($product_array as $key=>$value){
						?>
						<table>
						<form method="post" action="carti_politiste.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
