            ...
            <div class="tm-main-content">
                <section class="tm-margin-b-l">
                    ...
                    <div class="tm-gallery">
						...
						<?php
						$product_array = $db_handle->runQuery("SELECT * FROM produse WHERE timp='st' and scoala='gim' and subiect='engl' and student='nu' and domeniu='nudom' and tip='nudo'  ORDER BY code ASC");
						if (!empty($product_array)) { 
							foreach($product_array as $key=>$value){
						?>
						<table>
						<form method="post" action="engleza_5-8.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
